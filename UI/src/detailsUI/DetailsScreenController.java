...
import detailsUI.selectedComponent.entity.EntityDetailsController;
import detailsUI.selectedComponent.environment.EnvironmentDetailsController;
import detailsUI.selectedComponent.grid.GridDetailsController;
import detailsUI.selectedComponent.termination.TerminationDetailsController;
import detailsUI.simulationBreakdown.SimulationBreakdownController;
...
public class DetailsScreenController {
    ...
    public void entitiesShowButtonClicked(EntityDefinitionDTO EntityData) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/detailsUI/selectedComponent/entity/EntityDetails.fxml"));
    ...
    public void environmentShowButtonClicked(PropertyDefinitionDTO EnvironmentData) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/detailsUI/selectedComponent/environment/EnvironmentDetails.fxml"));
            Parent entityContent = loader.load();
...
//        }
    ...
    public void terminationShowButtonClicked(TerminationDTO terminationDTO) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/detailsUI/selectedComponent/termination/TerminationDetails.fxml"));
    ...
    public void gridShowButtonClicked(Integer rows, Integer cols) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/detailsUI/selectedComponent/grid/GridDetails.fxml"));
