package newExecutionUI.environmentInputs;
...
import newExecutionUI.environmentInputs.typeBoolean.EnvTypeBooleanController;
import newExecutionUI.environmentInputs.typeNumber.EnvTypeNumberController;
import newExecutionUI.environmentInputs.typeString.EnvTypeStringController;
...
public class EnvironmentInputsController {
    ...
    private void createStringEnvData(EnvironmentDefinitionDTO currEnv) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/newExecutionUI/environmentInputs/typeString/EnvTypeString.fxml"));
    ...
    private void createBooleanEnvData(EnvironmentDefinitionDTO currEnv) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/newExecutionUI/environmentInputs/typeBoolean/EnvTypeBoolean.fxml"));
    ...
    private void createNumberEnvData(EnvironmentDefinitionDTO currEnv) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/newExecutionUI/environmentInputs/typeNumber/EnvTypeNumber.fxml"));
